...
import { empty, full } from '../../components/stars';
...
export default function PetSitter() {
  ...
  return (
    <>
    <header>
    <Link className='a' href='/petsitter/tasks'>Tasks</Link>
    <Link className='a' href='/'>Log-out</Link>
      </header>
    <main className='main'>     
    <Container id='profile-petsitter'>
            <h1>Name Sur.</h1>
            ...
            <Row>
                <Col className='m-3'><svg width="50" height="50" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col className='m-3'><svg width="50" height="50" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col className='m-3'><svg width="50" height="50"  viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Row>
                ...
                <Col className='m-3'><svg width="50" height="50"  viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col className='m-3'><svg width="50" height="50"  viewBox="0 0 9 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Button id='edit-button' variant='success'>Edit</Button>
        </Container>
    </main>
    </>
  )
